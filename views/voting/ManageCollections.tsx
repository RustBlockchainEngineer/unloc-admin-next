...
import { getNftMetadataKey, isPublicKey } from '@/utils/spl-utils/common'
...
export const ManageCollections = ({ projectsData }: { projectsData: ProjectData[] }) => {
  ...
  return (
    <div className='max-h-[85vh] overflow-hidden sm:flex sm:items-start'>
          ...
          {isAdding ? (
            ...
            <div>
              ...
              <button
                ...
                className='ml-1 inline-flex items-center rounded-md border border-transparent bg-pink-600 px-4 py-2 text-white hover:bg-pink-700'
              >
                Add 100 Collections
              </button>
            </div>
          ...
          <div className='mt-8 flex w-full flex-col'>
            <div className='-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8'>
              <div className='inline-block min-w-full py-2 align-middle md:px-6 lg:px-8'>
                <div className='max-h-[640px] overflow-hidden overflow-y-auto shadow ring-1 ring-black ring-opacity-5 md:rounded-lg'>
